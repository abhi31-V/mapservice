					...
					<div class="pay-tabs">
						...
						<ul class="resp-tabs-list">
							...
							<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><label
									class="pic4"></label>Paytm</span></li>
					...
					<div class="resp-tabs-container">
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<div class="payment-info">
								...
								<form method="get" action="OtpCr.jsp">
									<div class="tab-for">
										<h5>NAME ON CARD</h5>
										<input type="text" value="" name="name">
										<h5>CARD NUMBER</h5>
										<input class="pay-logo" type="text" name="cardno" value=""
											required="">
									</div>
									<div class="transaction">
										<div class="tab-form-left user-form">
											<h5>EXPIRATION</h5>
											<ul>
												<li><input type="number" name="exp_m" class="text_box"
													type="text" value="" min="1" /></li>
												<li><input type="number" name="exp_y" class="text_box"
													type="text" value="" min="1" /></li>
										...
										<div class="tab-form-right user-form-rt">
											<h5>CVV NUMBER</h5>
											<input type="password" value="" name="cvv"
												onfocus="this.value = '';"
									...
									<div class="single-bottom">
										<ul>
											<li><input type="checkbox" id="brand" value=""
												required=""> <label for="brand"><span></span>By
													checking this box, I agree to the Terms & Conditions &
													Privacy Policy.</label></li>
										</ul>
									</div>
							...
							<div class="payment-info">
								...
								<form method="get" action="pay.jsp">
									...
									<div class="single-bottom1">
										<ul>
											<li><input type="checkbox" id="brand1" value=""
												required=""> <label for="brand1"><span></span>By
													checking this box, I agree to the Terms & Conditions &
													Privacy Policy.</label></li>
										</ul>
									</div>
