...
<head>
<h1>
	<font size="30"><center>List of Electricians</center></font>
</h1>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>List of Welder</title>
</head>
<body bgcolor="">
	<%
...
ResultSet rs=st.executeQuery("select * from ServiceProviderDetail where speciality='Electrician'");%><br>
	<br>
	<br>
