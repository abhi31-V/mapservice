...
<head>
<h1>
	<font size="30"><center>List of Carpenters</center></font>
</h1>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>List of Carpenter</title>
</head>
<body bgcolor="">
	<%
...
ResultSet rs=st.executeQuery("select * from ServiceProviderDetail where speciality='Carpenter'");%><br>
	<br>
	<br>
...
#customers th {
	...
	<center>
		<table id="customers" border="1" cellspacing="0" border color="green">
			<tr><th><font size="5">Name</font></th>
