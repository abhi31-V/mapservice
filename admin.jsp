...
#customers th {
  ...
  color: white;
      ...
      <body> 
      <div ><h1 style="color:green">User Details</h1></div>
      <%
...
Statement st = co.createStatement();
 ...
 String command1 ="select * from USER_INFO" ;
 %>
 <div class="scroll">
...
while(rs.next()) { 
 ...
 p1=rs.getString("NAME");
 n=rs.getInt("STATUS");
 id=rs.getString("mobile_no");
 %>
  <tr>
   ...
   <%        if(n ==1)
       ...
       <td><a href="edituser.jsp?u=<%=rs.getString("EMAIL")%>">Edit</a>  </td>    
  </tr>
